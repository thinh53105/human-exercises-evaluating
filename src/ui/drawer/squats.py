...
class SquatsDrawer:
    ...
    def __init__(self, btn_file_func, btn_camera_func, btn_stop_func, btn_back_func):
        ...
        self.lbl_title = Label(
            (45, 0), (700, 60), None,
            'SQUATS EVALUATING', 700, 
            (255, 255, 255), 1, 5
        )
        self.frame_squats = ImageFrame(
            (0, 0), (1000, 600),
            color=None,
            image=None,
            image_path='src/sample_images/squats.png'
        )
        ...
        self.div_exercise.add_util(self.frame_squats)
