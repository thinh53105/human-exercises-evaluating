...
if __name__ == '__main__':
    ...
    predictor = SquatsPredictor(
        [
        'src/predictor/squats/models/mobinet-20220724_up.tflite',
        'src/predictor/squats/models/mobinet-20220724_down.tflite'
        ]
    )
